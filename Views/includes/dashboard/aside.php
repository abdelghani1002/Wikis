<aside class="md:w-1/6 h-[88dvh] bg-emerald-400 -translate-x-[90px] md:-translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto dark:bg-gray-800">
        <ul class="h-full font-medium flex flex-col justify-between">
            ...
            <div>
                <li>
                    <a href="<?= $_ENV["APP_URL"] . "/logout" ?>" class="flex flex-row-reverse md:flex-row justify-between md:justify-normal items-center p-2 text-gray-900 rounded-lg dark:text-white bg-gray-300 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 m-0 md:ms-3 whitespace-nowrap">Log out</span>
                    </a>
                </li>
            </div>
        </ul>
